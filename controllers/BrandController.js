...
//   try {
//     let data = new Brandcategory(req.body)
//     if(req.file){
...
//     let errorMessage={}
//     error.keyValue?errorMessage.name="Brandcategory With Same Name Already Exists":null
...
//   try {
//     let data = await Brandcategory.find().sort({_id:-1})
//     res.send({
//      result:"done",
//      length:data.length,
//      data:data
...
//     try {
//       let data = await Brandcategory.findOne({_id:req.params._id})
//      if(data){
//         res.send({
//             result:"done", 
//             data:data
